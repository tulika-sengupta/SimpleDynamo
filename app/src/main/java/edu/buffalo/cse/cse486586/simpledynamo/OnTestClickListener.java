...
/**
 * Created by Tulika on 06-05-2017.
 */
...
public class OnTestClickListener implements View.OnClickListener {
    ...
    private class Task extends AsyncTask<Void, String, Void> {
        ...
        private boolean testInsert() {
            //Log.v("In Insert:","Inserting values");
            try {
                for (int i = 0; i < TEST_CNT; i++) {
            ...
            try {
                ...
                if (resultCursor.moveToFirst()) {
                    do {
                        ...
                        Log.v("Key: "+returnKey,"Value: "+ returnValue);
...
//                    String returnKey = resultCursor.getString(keyIndex);
//                    String returnValue = resultCursor.getString(valueIndex);
//                    Log.v("Key: "+key + " returnKey: "+returnKey, "val: "+val +" returnValue: "+ returnValue);
