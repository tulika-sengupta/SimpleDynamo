//// ALL the client calls in the insertValues. And thread.sleep in insert()   --- MOST RECENT  20.24 pm   TILL PHASE 3
//
...
//
//                        packetInfo pCoord = new packetInfo("Replicate", key, value,true, coord);
//                        packetInfo pReplicate1 = new packetInfo("Replicate",key, value, true, replicatePort1);
//                        packetInfo pReplicate2 = new packetInfo("Replicate", key, value, true, replicatePort2);
//
...
//            packetInfo p = pack[0];
//            try {
//                Log.v("CLIENT: ", p.msgType + "   KEY: "+ p.contentKey + "   " );
//                Log.v("CLIENT: ",p.msgType + " TO PORT: " + p.portId + "  " );
